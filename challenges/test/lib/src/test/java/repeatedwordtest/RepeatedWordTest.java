...
import static code.repeatedword.RepeatedWord.repeatedWord;
import static org.junit.Assert.*;

public class RepeatedWordTest {

  @Test
  public void testingRepeatedWord(){
      ...
      assertEquals("a",repeatedWord(one));
      assertEquals("it",repeatedWord(two));
      assertEquals("summer",repeatedWord(three));
  }
}
